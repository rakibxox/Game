...
public class Main {
    ...
    public static void main(String[] args ){
        ...
        title2 =new JLabel("Player X, It's your turn");
                ...
                label.addMouseListener(new MouseListener(){
                    ...
                    if(enabled){
                        ...
                        if(turn == 'X'){
                            ...
                            turn = '0';
                            title2.setText("Player 0, It's your turn");
                        }
                        else{
                            label.setForeground(Color.RED);
                            turn ='X';
                            title2.setText("Player X, It's your turn");
                        }
                        }else{
                            title2.setText("Postion Taken!");
                                }
                    if(checkWinner () && winner.equals("X"))
                    {
                        title2.setText("Player X win!");
                        title2.setForeground(Color.blue);
                        enabled = false;
                    }
                    else if (checkWinner () && winner.equals("0")){
                        title2.setText("Player 0 win!");
                        title2.setForeground(Color.blue);
                        enabled = false;
                    }
                        else if (!draw()){
    ...
    }else if(chars[0][2]==chars[1][2] && chars[0][2]==chars[2][2] && chars[0][0]!=0){
        win = true;
    ...
    private static void reboot(){
        chars=new char[3][3];
        winner = " ";
        title2.setText("Player X, It's your trun");
